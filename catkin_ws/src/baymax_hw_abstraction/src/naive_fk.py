...
# links
tf_base1 = np.array([[0, 0, 0.066]])
tf_12 = np.array([[0, 0, 0.0415]])
tf_23 = np.array([[-0.0828, 0, 0]])
tf_34 = np.array([[-0.0828, 0, 0]])
tf_45 = np.array([[-0.0739, 0, 0]])
tf_4cam = np.array([[-0.072, -0.049, 0]])
tf_5tool = np.array([[0, 0, 0.08]])
...
def rot_base_to_cam(q0, q1, q2, q3):
    ...
    rot_12 = std_rotation_y(np.pi/2) @ std_rotation_z(q1)
    rot_23 = std_rotation_z(q2)
    rot_3cam = std_rotation_z(q3)

    return rot_b1 @ rot_12 @ rot_23 @ rot_3cam